...
The current local STT target for the MVP is faster-whisper. Recording, silence detection, and UI diagnostics are already in place; the next session is planned around integrating the first real faster-whisper transcriber.
